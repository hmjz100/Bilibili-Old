...
export class PageIndex extends Page {
	constructor() {
		...
		(<any>window).__ADdata__ = __INITIAL_STATE__.locsData;
		this.locsData();
		this.recommendData();
		this.roomRecommend();
		this.ranking();
	...
	protected locsData() {
		apiWebshowLocs({ ids: [23, 29, 31, 34, 40, 42, 44, 1550, 3197, 3441, 3443, 3449, 3455, 4694] })
			.then(d => {
				...
				__INITIAL_STATE__.locsData[34] = this.adblock(d[3197]);
				...
				__INITIAL_STATE__.locsData[1550] = this.adblock(d[1550]);
				__INITIAL_STATE__.locsData[3197] = this.adblock(d[3197]);
				__INITIAL_STATE__.locsData[3441] = this.adblock(d[3441]);
				__INITIAL_STATE__.locsData[3443] = this.adblock(d[3443]);
				__INITIAL_STATE__.locsData[3449] = this.adblock(d[3449]);
				__INITIAL_STATE__.locsData[3455] = this.adblock(d[3455]);
				__INITIAL_STATE__.locsData[4694] = this.adblock(d[4694]);
			})
			.catch(e => {
