...
import htmlVideo from '../html/video.html';
...
export class PageVideo extends Page {
	...
	constructor() {
		...
		location.href.replace(/BV[0-9A-Za-z]{10}/i, d => this.bvid = d);
		new Comment();
		this.like = new Like();
