// ==UserScript==
// @name         Bilibili 旧播放页（改）
// @namespace    MotooriKashin
// @version      7.2.3
// @description  恢复Bilibili旧版页面，为了那些念旧的人。（侵删）
// @author       MotooriKashin，wly5556，hmjz100
// @homepage     https://github.com/hmjz100/Bilibili-Old
// @supportURL   https://github.com/hmjz100/Bilibili-Old/issues
    ...
    API.xhrhookasync("/playurl?", args => {
        ...
        if (API.globalLimit) { // 处理泰区视频
            ...
            try {
                ...
                response = { "code": 0, "message": "success", "result": response };
                API.__playinfo__ = response;
                API.toast.success(\`解除区域限制！</br>aid=\${API.aid}, cid=\${API.cid}\`);
            }
            catch (e) {
                API.toast.error("videoLimit.js", e);
                response = { "code": -404, "message": e, "data": null };
...
`"use strict";
    ...
    registerSetting({
        ...
        key: "toast",
        label: "浮动通知",
        sub: '使用toastr作为浮动通知</br>在<a href="//github.com/CodeSeven/toastr">Github</a>上查看toastr',
        ...
        list: [{
                ...
                sort: "common",
                action: () => {
                API.toast("这是一条普通浮动通知~</br>(>_<)");
                API.toast.info("这是一条提示浮动通知~</br>(>_<)");
                API.toast.error("这是一条错误浮动通知~</br>(>_<)");
                API.toast.warning("这是一条警告浮动通知~</br>(>_<)");
                API.toast.success("这是一条成功浮动通知~</br>(>_<)");
                }
            }, {
                type: "action",
                key: "testmessage",
                label: '呼出<strong>百条</strong>通知',
                float: \`呼出测试通知以便<strong>测试性能</strong>\`,
                title: '<strong>显示</strong>',
                sort: "common",
                action: () => {
                API.toast("这是百条普通浮动通知~</br>(>_<)1");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)2");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)3");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)4");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)5");
                API.toast("这是百条普通浮动通知~</br>(>_<)6");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)7");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)8");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)9");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)10");
                API.toast("这是百条普通浮动通知~</br>(>_<)11");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)12");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)13");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)14");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)15");
                API.toast("这是百条普通浮动通知~</br>(>_<)16");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)17");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)18");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)19");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)20");
                API.toast("这是百条普通浮动通知~</br>(>_<)21");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)22");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)23");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)24");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)25");
                API.toast("这是百条普通浮动通知~</br>(>_<)26");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)27");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)28");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)29");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)30");
                API.toast("这是百条普通浮动通知~</br>(>_<)31");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)32");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)33");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)34");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)35");
                API.toast("这是百条普通浮动通知~</br>(>_<)36");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)37");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)38");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)39");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)40");
                API.toast("这是百条普通浮动通知~</br>(>_<)41");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)42");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)43");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)44");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)45");
                API.toast("这是百条普通浮动通知~</br>(>_<)46");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)47");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)48");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)49");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)50");
                API.toast("这是百条普通浮动通知~</br>(>_<)51");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)52");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)53");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)54");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)55");
                API.toast("这是百条普通浮动通知~</br>(>_<)56");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)57");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)58");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)59");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)60");
                API.toast("这是百条普通浮动通知~</br>(>_<)61");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)62");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)63");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)64");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)65");
                API.toast("这是百条普通浮动通知~</br>(>_<)66");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)67");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)68");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)69");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)70");
                API.toast("这是百条普通浮动通知~</br>(>_<)71");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)72");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)73");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)74");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)75");
                API.toast("这是百条普通浮动通知~</br>(>_<)76");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)77");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)78");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)79");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)80");
                API.toast("这是百条普通浮动通知~</br>(>_<)81");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)82");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)83");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)84");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)85");
                API.toast("这是百条普通浮动通知~</br>(>_<)86");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)87");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)88");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)89");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)80");
                API.toast("这是百条普通浮动通知~</br>(>_<)91");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)92");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)93");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)94");
                API.toast.success("这是百条成功浮动通知~</br>(>_<)95");
                API.toast("这是百条普通浮动通知~</br>(>_<)96");
                API.toast.info("这是百条提示浮动通知~</br>(>_<)97");
                API.toast.error("这是百条错误浮动通知~</br>(>_<)98");
                API.toast.warning("这是百条警告浮动通知~</br>(>_<)99");
                API.toast.success("这是百条成功浮动通知！~</br>(>_<)100");
                }
            }]
    });
    registerSetting({
...
`"use strict";
    class EmbedPlayer {
        ...
        createNoFlashTipsInstance() {
                ...
                btnList: [
                    {
                        ...
                        theme: "red",
                        onClick: (e) => {
                            window.location.href="//addbeflashlite.epizy.com/zh-cn"
                        }
                    }, {
                        title: "使用HTML5播放器",
                        width: 166,
            ...
            API.toast.error("未安装Flash插件，请安装Flash或使用HTML5播放器！"),
...
`"use strict";
    class Toast {
        ...
        static init() {
            ...
            this.style.setAttribute("href", "//cdn.bootcdn.net/ajax/libs/toastr.js/latest/toastr.min.css");
        }
...
`"use strict";
    ...
    class Collection {
        constructor(videoData) {
            ...
            API.toast.warning("视频合集，正在以分P样式呈现", "如需关闭，请访问 设置-重构-合集 选项。");
        }
...
`"use strict";
    ...
    API.xhrhook("api.bilibili.com/x/space/acc/info", undefined, obj => {
        if (obj.responseText && obj.responseText.includes("-404")) {
            obj.response = obj.responseText = JSON.stringify(response);
            API.toast.error("该用户无法访问(-404)");
            API.toast.warning("该用户无法访问(-404)，已使用缓存数据恢复访问");
        }
    }, false);
